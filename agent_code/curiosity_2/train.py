...
from functions import augment, select_features, masked_mean_squared_error, to_features, to_labels, masked_mae
...
def end_of_round(self, last_game_state, last_action, events):
    ...
    X_policy = old_features_aug#.reshape([old_features_aug.shape[0], 17*17*12])
