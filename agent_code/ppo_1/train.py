...
def setup_training(self):
    if False:
        ...
        self.actor.compile(Adam(3e-4), loss=mean_squared_error)
        self.critic.compile(Adam(3e-4), loss=mean_squared_error)
...
def end_of_round(self, last_game_state, last_action, events):
    ...
    reward = c_fator*aux_reward+(1-c_factor)*(last_game_state['self'][1])
